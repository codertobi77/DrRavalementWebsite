          ...
          <div className="text-center">
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-8 mb-8">
              ...
              <p className="text-orange-700 mb-6">
                Le calculateur de devis est actuellement en maintenance. 
                Notre équipe travaille pour améliorer cet outil et le rendre encore plus précis.
              </p>
              <div className="bg-white rounded-lg p-4 border border-orange-200">
                <p className="text-sm text-gray-600 mb-2">
                  <strong>En attendant, vous pouvez :</strong>
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• Demander un devis personnalisé par téléphone</li>
                  <li>• Prendre rendez-vous pour une visite technique gratuite</li>
                  <li>• Nous contacter via le formulaire de contact</li>
                </ul>
              </div>
            </div>
